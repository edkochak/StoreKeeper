...
async def test_excel_report_structure(session):
    ...
    test_data = [
        {"store_name": "Магазин №1", "date": "2023-05-01", "amount": 1000.0, "plan": 5000.0},
        {"store_name": "Магазин №1", "date": "2023-05-02", "amount": 1200.0, "plan": 5000.0},
        {"store_name": "Магазин №2", "date": "2023-05-01", "amount": 800.0, "plan": 4000.0},
        {"store_name": "Магазин №2", "date": "2023-05-02", "amount": 850.0, "plan": 4000.0},
    ]
    
    with patch.object(RevenueService, '_get_revenue_for_report', return_value=test_data):
        # Генерируем отчет
