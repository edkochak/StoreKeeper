...
/editstore - Редактировать существующий магазин
/editmanager - Редактировать существующего менеджера
...
def get_main_keyboard(role: str = None):
    ...
    if role == "admin":
        ...
        builder.row(
            types.KeyboardButton(text="/editstore"),
            types.KeyboardButton(text="/editmanager"),
        )
        builder.row(
